...
export const Gifts = [
  ...
  {
    type: "message",
    content: "Não importa a distância, meu amor por você só cresce a cada dia.",
  },
  {
    type: "image",
